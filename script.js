...
function getWeatherData(city, unit, hourlyorWeek) {
  const apiKey = "MKE6R88NGJ67PAR9USCKJJT3J";
  fetch(
    ...
    .then((data) => {
      ...
      // You may need to define the corresponding functions like 'getIcon', 'changeBackground', 'updateHumidityStatus', etc.
      // Update these accordingly based on your actual implementation
